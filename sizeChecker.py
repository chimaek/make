...
# Directories
train_directory = './data/images/train' # It should contain the xml files with bounding boxes
test_directory = './data/images/test' # It should contain the xml files with bounding boxes
